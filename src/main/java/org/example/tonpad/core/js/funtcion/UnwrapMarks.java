...
@Component("unwrapMarks")
public class UnwrapMarks extends JsFunction<Integer> {
    public UnwrapMarks(TonpadConfig config, RegularFileService fileService) { super(config, fileService); }
